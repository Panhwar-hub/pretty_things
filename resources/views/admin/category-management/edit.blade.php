      ...
      <div class="row">
        <div class="col-lg-6 col-md-12 col-12">
          <div class="form-group">
            ...
            <input type="text" name="title" id="name" value="{{$category->title}}" class="form-control"
        ...
        <div class="col-lg-6 col-md-6 col-12">
          <div class="form-group">
            <label>Slug*:</label>
            <input type="text" name="slug" id="slug" required value="{{$category->slug}}" class="form-control"
