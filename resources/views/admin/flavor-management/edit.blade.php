...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.saveflavor')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                    <label>Name:</label>
                                    <input type="text"  class="form-control" name="name"  required   placeholder="Enter Name" value="{{$flavor->name}}">
                            ...
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                    <label>Code:</label>
                                    <input type="text"  class="form-control" name="code"  required   placeholder="Enter Code" value="{{$flavor->code}}">
