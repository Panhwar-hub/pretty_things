                ...
                <div class="invoice">
                        ...
                        <table id="user-table" class="table table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <td></td>
                                <td></td>
                                    <td class="text-right" colspan="2"><h6>Subtotal Total</h6></td>
                                    <td>${{$grand_total}}</td>
                                ...
                                <td></td>
                                    ...
                                    <td class="text-right" colspan="2"><h6>Coupon Discount:({{$orders->coupon_code}})</h6></td>
                                ...
                                <td></td>
                                    <td></td>
                                    <td class="text-right" colspan="2"><h6>Grand Total</h6></td>
