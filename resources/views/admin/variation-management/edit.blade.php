...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.savevariation')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="product" required>
                                      ...
                                      <option {{$variation->product_id == $p->id ? 'selected':''}}  value="{{$p->id}}">{{$p->name}}</option>
                                      @endforeach
                                  </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                  ...
                                  <select  class="form-control" name="color" required>
                                      @foreach($color as $c)
                                      <option {{$variation->color_id == $c->id ? 'selected':''}} value="{{$c->id}}">{{$c->name}}</option>
                                      @endforeach
                                  </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" name="size_name"  required value="{{$variation->size_name}}"  placeholder="Enter Size Name" >
