...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.savequestion')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="product" value="{{isset($faq->questionBelongsToProducts) && null !== $faq->questionBelongsToProducts ?  $faq->questionBelongsToProducts->id : '--'}}">
                            ...
                            <div class="form-group">
                                ...
                                <li class="list-inline-item">
                                    <div class="checkbox">
                                    <input type="radio" id="user1" name="is_active" {{$faq->is_active == 1 ? 'Checked' : ''}}   value="1">
                                    <label for="user1">Active</label>
                                    </div>
                                </li>
                                <li class="list-inline-item">
                                    <div class="checkbox">
                                    <input type="radio" id="user2" name="is_active" {{$faq->is_active == 0 ? 'Checked' : ''}}  value="0" >
