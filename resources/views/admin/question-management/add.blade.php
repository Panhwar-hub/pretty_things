...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.create_ingredient')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    <label>Answer:</label>
                                    <textarea rows="5" class="form-control" name="answer" required id="editor2"  placeholder="Enter Answer"></textarea>
