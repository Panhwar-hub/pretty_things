...
<div class="main-sec">
    <div class="main-wrapper">
        ...
        <form action="{{route('admin.create_brand')}}" method="POST" enctype="multipart/form-data"
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="form-group">
                        <label>Slug*:</label>
                        <input type="text" readonly name="slug" id="slug" required class="form-control" placeholder="Enter Slug">
                        @if ($errors->has('slug'))
