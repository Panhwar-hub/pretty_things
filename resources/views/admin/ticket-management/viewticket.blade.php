...
<div class="container">
    <div class="row">
        ...
        @if($myticket->is_active == 0)
                   <a href="{{route('admin.ticketclosed',$myticket->id)}}" class="primary-btn primary-bg">Ticket Closed</a>
                   @endif     
        ...
        @foreach($ticketchat  as $t)
                                    ...
                                    @if($ticketchat[0]->ticketBelongsTochat->is_active == 0 || $ticketchat[0]->ticketBelongsTochat->is_active == 1)    
                                    <div class="message-form main-form">
                                        <form id="admin-chatroom-form">
...
(()=>{
  ...
  $('.add-pets-submit').click(function(e){
        ...
        var data = new FormData(document.getElementById("admin-chatroom-form"));
    
      
          var url = '{{ route('admin.chatmessage') }}';
