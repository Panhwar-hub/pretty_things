                    ...
                    <form id="add-record-form" action="{{route('admin.savetestimonial')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" required class="form-control" value="{{$testimonial->name}}" placeholder="Enter Name">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" id="designation" value="{{$testimonial->designation}}"  class="form-control" placeholder="Enter Designation">
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <figure><img src="{{asset($testimonial->img_path)}}" class="thumbnail-img" alt="user-img"></figure>
