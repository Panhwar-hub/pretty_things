...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.updatewelcomeSlider')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="img-upload-wrapper  mc-b-3">
                              <h3>Slider Image</h3>
                              <figure><img src="{{asset($welcome_slider->img_path)}}" class="thumbnail-img" alt="user-img"></figure>
                              ...
                              <input type="file"  onchange="thumb(this);" name="welcomeslider" id="thumbnail-img" class="d-none"  accept="image/jpeg, image/png">
                               @if ($errors->has('welcomeslider'))
                                        <span class="text-danger">{{ $errors->first('welcomeslider') }}</span>
                                    @endif
                            </div>
                           </div>
