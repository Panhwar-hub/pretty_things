...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.createwelcomeSlider')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="img-upload-wrapper  mc-b-3">
                              ...
                              <input type="file" required onchange="thumb(this);" name="welcomeslider" id="thumbnail-img" class="d-none"  accept="image/jpeg, image/png">
                            </div>
                           </div>
